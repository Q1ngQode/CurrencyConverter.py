...
response = requests.get(f"https://data.fixer.io/api/latest?ratespython3?access_key=f5b6b69539cb465b8ec9bcd7226c9350?amount={amount}&from={from_currency}&to={to_currency}")
